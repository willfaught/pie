...
alias cdm "cd $HOME/Developer/mac"
...
alias gidom 'git diff origin/main'
...
alias gilm 'git log main'
alias gilom 'git log origin main'
alias gim 'git merge'
alias gima 'git merge --abort'
alias gimc 'git merge --continue'
alias gip 'git pull'
alias gipom 'git pull origin main'
...
alias girbim 'git rebase -i main'
alias girbm 'git rebase main'
alias girbom 'git rebase origin/main'
alias girs 'git reset'
alias girsh 'git reset --hard'
alias girshm 'git reset --hard main'
alias girshom 'git reset --hard origin/main'
...
function gibdrb
  git checkout main; and git pull origin; and git checkout $argv[1]; and git rebase main; and git checkout main; and git branch -d $argv[1]
end
