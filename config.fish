...
alias girtam 'git remote add me'
alias girtao 'git remote add origin'
alias girtau 'git remote add upstream'
...
alias girtspm 'git remote set-url --push me'
alias girtspo 'git remote set-url --push origin'
alias girtspu 'git remote set-url --push upstream'
alias girtsm 'git remote set-url me'
alias girtso 'git remote set-url origin'
alias girtsu 'git remote set-url upstream'
